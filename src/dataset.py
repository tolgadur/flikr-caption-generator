...
class Flickr30kDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_embeds = image_outputs.pooler_output  # shape: [1, 768] - CLS token
        input_embeds = input_outputs.last_hidden_state  # shape: [5, 25, 512]
        target_embeds = target_outputs.last_hidden_state  # shape: [5, 25, 512]
